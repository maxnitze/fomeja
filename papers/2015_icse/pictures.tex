...
\newcommand{\tikzarchitecture}{
  \begin{tikzpicture}[node distance=2.5cm]
    ...
    \node[block, below=.5cm of smt2name] (smt2converter) {convert abstract
        abstracts to \emph{smt2}-expression};
    ...
    \end{scope}
    % Allocator
    \node[containertitle,right=2cm of smt2name] (modname) {ModelHandler};
    ...
    \draw[line] (smt2solver.east) -- ++(.85,0) |-  (assigner.west);
  \end{tikzpicture}
}
...
\newcommand{\tikzjvm}{
  \begin{tikzpicture}
    ...
    \draw[very thick,fill=blue!36] (0,5) rectangle (10,6)
      node[midway,align=center] {\Large JVM};
